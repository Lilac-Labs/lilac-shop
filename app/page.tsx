 ...
 <div className="bg-rose-200	my-10 flex flex-auto flex-row justify-center items-center text-center">
            <div>
              ...
              <div className="mb-3 flex flex-row justify-center h-full w-full">
                <Image className="mx-2 h-full" src="/brand-logos/brand-logo-1.png" width={100} height={100} alt="brand-logo-1"/>
                <Image className="mx-2 h-full" src="/brand-logos/brand-logo-2.png" width={100} height={100} alt="brand-logo-2"/>
                <Image className="mx-3 h-full" src="/brand-logos/brand-logo-3.png" width={60} height={60} alt="brand-logo-3"/>
                <Image className="mx-2 h-full" src="/brand-logos/brand-logo-4.png" width={75} height={75} alt="brand-logo-4"/>
              </div>
            </div>
          </div>
          <div className="my-10 h-full flex flex-auto xl:px-0 flex-row justify-center">
            <div className="w-8/12 flex flex-row justify-evenly overflow-hidden">
                {demo.map(({ pfpPath, shoplink, product1img, product1link, product2img, product2link}) => (
                <ProductDemo pfpPath={pfpPath}
                            shoplink={shoplink}
