    ...
    <Modal showModal={showCreatorsApplyModal} setShowModal={setCreatorsApplyModal}>
      <div className="w-full overflow-hidden shadow-xl md:max-w-2xl md:rounded-2xl md:border md:border-gray-200">
        <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 bg-white px-4 py-6 pt-8 text-center md:px-16">
          ...
          <h1 className="font-display text-3xl font-bold">Apply to join.</h1>
          <p className="text-sm">
        ...
        <Form.Root className="FromRoot">
            <Form.Field className="FormField" name="name">
                ...
                <Form.Control asChild>
                    <input className="Input valid:border-gray-500 invalid:border-red-500" type="text" required placeholder="Name"/>
                </Form.Control>
            </Form.Field>
            ...
            <Form.Field className="FormField" name="bio">
                ...
                <Form.Control asChild>
                    <textarea className="w-full" required placeholder="Briefly describe who you are and the types of content you promote regularly on your social channels."/>
                </Form.Control>
            </Form.Field>
            <Form.Field className="FormField" name="links">
                ...
                <Form.Control asChild>
                    <textarea className="w-full" required placeholder="Provide links to your social media channels"/>
                </Form.Control>
            </Form.Field>
            <Form.Submit asChild>
                <button className="mx-2 rounded-full border border-black bg-black p-1.5 px-4 text-sm text-white transition-all hover:bg-white hover:text-black" style={{ marginTop: 10 }}>
                    Apply
                </button>
            </Form.Submit>
        </Form.Root>
